...
$getEmail = mysqli_query($conn,"SELECT * FROM stu_class WHERE stu_eml ='$teacher_name'");
...
if(mysqli_query($conn,"INSERT INTO stu_subject(subject_code,stu_email) VALUES ('$class_code','$teacher_name')")){
